...
import team2img from "./img/team-2.png"
                ...
                <div class="custom-row row">
                    ...
                    <div class="custom-column column">
                        <div class="team">
                            ...
                            <div class="team-content">
                                <h2 className='heading2'>Vikas Paswan</h2>
                                <h3 className='heading3'>FrontEND and BackEND DEV</h3>
                                <h4>vikas.paswan@iiitg.ac.in</h4>
                            </div>
                            <div class="team-social">
                                <a target="_blank" href="#" class="social-li"> <i class="fab fa-linkedin-in"></i></a>
                                <a target="_blank" href="#" class="social-github"> <i class="fa-brands fa-github"></i></a>
                                <a target="_blank" href="#" class="social-fb"> <i class="fab fa-facebook-f"></i></a>
                            </div>
                        </div>
                    </div>
